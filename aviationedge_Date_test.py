...
def append_arrivals_to_csv(arrivals_df, csv_file_path):
    ...
    # Add flight_type summary statistics
    flight_type_summary = arrivals_df['flight_type'].value_counts().to_dict()
    summary.update(flight_type_summary)
...
base_csv_path = 'C:/Users/josti/OneDrive/Desktop/Gitlab clone/LDR/FlightViz/arrival2_arrival_flights_summary'
...
if arrival_stats:
    ...
    summary_df.fillna(0).to_csv('arrival2_arrival_summary_statistics.csv', index=False)
