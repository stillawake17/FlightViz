...
def process_arrival_data(file_path):
    ...
    for flight in flights_data:
        if (flight['type'] == 'arrival' and 
            ...
            #print(f"Processed flight info: {flight_info}")
...
arrival_csv_path = 'C:/Users/josti/OneDrive/Desktop/Gitlab clone/LDR/FlightViz/arrival_flights_summary.csv'
...
for file_path in file_paths:
    try:
        ...
        if not arrivals_df.empty:
            day_summary = append_arrivals_to_csv(arrivals_df, arrival_csv_path)
            day_summary['date'] = file_path[-14:-5]
...
if arrival_stats:
    ...
    summary_df.fillna(0).to_csv('arrival_summary_statistics.csv', index=False)
