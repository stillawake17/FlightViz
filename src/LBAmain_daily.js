...
function getTimeCategory(dateTimeString) {
    ...
    if ((hour === 23 ) || hour < 7) return "Night hour arrivals";
...
const filePath = '../LBA_combined_2024-04-03.json'; // Adjust this path as necessary
...
fs.readFile(filePath, 'utf8', (err, data) => {
    ...
    try {
        ...
        const outputFilename = `./LBAflights_by_day_${flightDate}.json`;
